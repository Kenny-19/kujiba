package org.unh.kujiba_v001.ui.theme
    ...
    SearchBar(
        ...
        trailingIcon = {
            Row {
                IconButton(onClick = { /* open mic dialog */ }) {
                    Icon(painter = painterResource(R.drawable.ic_launcher_foreground), contentDescription = "Mic")
                }
                if (active) {
                    IconButton(
        ...
        searchHistory.takeLast(3).forEach { item ->
            ListItem(
                ...
                leadingContent = {
                    Icon(
                        painter = painterResource(R.drawable.kujiba_app),
